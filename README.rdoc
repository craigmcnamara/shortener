...
Shortener is designed to work from within a Rails 4 and Rails 5.2+ applications. It has dependancies Rails core components like ActiveRecord, ActionController, the rails routing engine and more.
...
v0.7.0 drops support for Rails 3.x and supports Rails 4.2 to 5.2+
...
* The controller uses ActionController::Metal so our action is fast and doesn't perform any more work than necessary;
...
Shortener is compatible with Rails v4 and v5+. To install, add to your Gemfile:
